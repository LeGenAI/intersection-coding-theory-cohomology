...
\(\operatorname{rowspan}G'=P_\sigma(C)\), applying \(P_\sigma^{-1}\)
shows that the reconstructed code is permutation equivalent to \(C\), as
claimed.
\end{proof}
...
Moreover,
\[
-D\partial_2\ell_1=(1,4)^{\mathsf T},\qquad
-D\partial_2\ell_2=(4,2)^{\mathsf T},
\]
and the off-diagonal relation
...
so
\[
r=\dim(C\cap U_2)=4-\rank(\partial G_{2,2})=2.
\]
