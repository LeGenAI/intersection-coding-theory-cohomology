...
\begin{pmatrix}
~~~~~1, ~~~~~~~ 0, ~~~~ x  \\
\langle x,g_i\rangle,\langle x,g_i\rangle, ~~~~g_i
\end{pmatrix}
\]
...
In the statement of Theorem~\ref{thm:qary-building-up}, we want to show that
\begin{center}
\begin{tabular}{|lllll|}
\toprule
%$S$-units $\backslash$  places & $W_{p_1}$  & $W_{p_2}$ & $\cdots$ & $W_2$  & $W_{\mathbb R}$ \\
%\midrule
 01   & 00/$(\pm \alpha  ~\pm c\alpha )$  &  & 00/$(\pm \alpha  ~\pm  c\alpha )$ ~~1  &  0 \\
 $(\pm \alpha  ~\pm c\alpha  )$/00   & 01  &  & 00/$(\pm \alpha  ~\pm c \alpha  )$ ~~1  &  0 \\
 $\cdots$ &   &  $\ddots$ &   & $\vdots$ \\
 $(\pm \alpha ~\pm c \alpha )$/00   &   &   & 01 ~~~~~~~~~~~~~~~~~~1  &  0 \\
 $(\pm \alpha  ~\pm c \alpha )$ & $(\pm \alpha  ~\pm c\alpha )$  & $\cdots$ & $(\pm \alpha  ~\pm c \alpha )$  ~~~~~ 1 &  c \\
%-1  & 11   & 11  & $\cdots$ & 11~~1  &  0 \\
\bottomrule
\end{tabular}
\end{center}
