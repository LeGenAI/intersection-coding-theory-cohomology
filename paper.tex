...
row-equivalent universal generator is
\begin{equation}
\widehat G_{14}=\AppThirteenFourteenUniversal.
\label{eq:gf13-14-universal}
\end{equation}
...
\(TG_{14}^{\sigma}=\widehat G_{14}\). Applying
...
\]
and the lower six rows of \eqref{eq:gf13-14-universal}, after deleting their
