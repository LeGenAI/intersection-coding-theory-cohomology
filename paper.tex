...
G_{2,2}\longrightarrow G_{3,2}&((1,4),(2,0))&(1,2)\\
G_{3,2}\longrightarrow G_{4,2}&((2,0),(4,1))&(1,2,4)
\end{array}
\]
with each new pivot prepended. Both steps give \(a_0=2\). The final matrix is
\[
G_{4,2}=
...
Since these two steps have \(a_0=c\), their row scalings are the case
