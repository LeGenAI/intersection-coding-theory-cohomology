...
\]
and group consecutive coordinates into seven two-coordinate blocks. Put
\begin{equation}
b=\begin{pmatrix}
*&12&11&5&6&9\\
1&*&12&11&4&1\\
...
\end{pmatrix},
\qquad
(\ell_i)_{i=1}^6=((3,9),(9,10),(3,9),(4,3),(0,8),(3,9)),
\label{eq:gf13-14-coefficients}
\end{equation}
where the diagonal symbols in \(b\) are unused.  In the notation of
Theorem~\ref{thm:universal-rank-boxed}, a row-equivalent universal generator is
\begin{equation}
\widehat G_{14}=G(5;b,\ell,(1))=\AppThirteenFourteenUniversal.
...
9&7&4&12&1&4&5
\end{pmatrix},
\qquad \det T=\AppThirteenFourteenTransformDeterminant,
\]
...
Every pivot diagonal block is \(01\).  The six forced diagonal identities
and the off-diagonal relations
\(5(b_{ij}+b_{ji})+\ell_i\cdot\ell_j=0\) hold, so
