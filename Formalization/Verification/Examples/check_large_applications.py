...
def coefficient_matrix_tex(rows):
...
def large_application_tex(specification, universal, parent, parent_distribution,
    ...
    result += tex_macro("AppThirteenFourteenP", coefficient_matrix_tex(universal["P"]))
    result += tex_macro("AppThirteenFourteenH", coefficient_matrix_tex(universal["H"]))
    result += tex_macro("AppThirteenFourteenQ", coefficient_matrix_tex(universal["Q"]))
    result += tex_macro("AppThirteenFourteenA", coefficient_matrix_tex(universal["A"]))
